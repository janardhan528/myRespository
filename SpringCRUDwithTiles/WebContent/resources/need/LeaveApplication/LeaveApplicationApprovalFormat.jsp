...
<link
	href="http://<c:out value="${staticURL_mainTemplate}" />/resources/funwork-template/themes/oe/css/base.css"
	rel="stylesheet" />
			...
			<div class="openerp  oe_form_container">
				<div class="oe_application oe_form">
					<div class=" oe_form_sheetbg">
							...
							<div align="center">
								<h3>
									<label class="oe_form_label oe_align_center"> Leave Application</label>
									...
									<tbody>
										<tr class="oe_form_group_row">
											<td class="oe_form_group_cell" width="50%" colspan="1">
												<table class="oe_form_group " cellspacing="0"
													...
													<tbody>
														...
														<tr class="oe_form_group_row">
															...
															<td class="oe_form_group_cell" width="99%" colspan="1">
																<span
																class="oe_form_field oe_form_field_many2one oe_form_field_with_button oe_form_required">
																	<fmt:formatDate value="${leaveAppVO.leaveAppFromDate}" pattern="dd-MMM-yyyy" var="newdatevar" /><c:out value="${newdatevar}" />  </span>
															</td>
														</tr>
														<tr class="oe_form_group_row">
															<td class="oe_form_group_cell oe_form_group_cell_label"
														...
														<tr class="oe_form_group_row">
															<td class="oe_form_group_cell oe_form_group_cell_label"
																width="1%" colspan="1"><label
																class=" oe_form_label_help oe_align_right"
																for="oe-field-input-20" data-original-title="" title="">From Date</label></td>
															<td class="oe_form_group_cell" width="99%" colspan="1">
																<span
																class="oe_form_field oe_form_field_many2one oe_form_field_with_button oe_form_required">
																	<fmt:formatDate value="${leaveAppVO.leaveAppFromDate}" pattern="dd-MMM-yyyy" var="newdatevar" /><c:out value="${newdatevar}" /> </span>
														...
														<tr class="oe_form_group_row">
															<td class="oe_form_group_cell oe_form_group_cell_label"
																width="1%" colspan="1"><label
																class=" oe_form_label_help oe_align_right"
																for="oe-field-input-20" data-original-title="" title="">To Date</label></td>
															<td class="oe_form_group_cell" width="99%" colspan="1">
																<span
																class="oe_form_field oe_form_field_many2one oe_form_field_with_button oe_form_required">
																	<fmt:formatDate value="${leaveAppVO.leaveAppToDate}" pattern="dd-MMM-yyyy" var="newdatevar" /><c:out value="${newdatevar}" /></span>
															</td>
														</tr>
														...
														<tr class="oe_form_group_row">
															<td class="oe_form_group_cell oe_form_group_cell_label"
																width="1%" colspan="1"><label
																class=" oe_form_label_help oe_align_right"
																for="oe-field-input-20" data-original-title="" title="">No of Days</label></td>
															<td class="oe_form_group_cell" width="99%" colspan="1">
																<span
																class="oe_form_field oe_form_field_many2one oe_form_field_with_button oe_form_required">
													...
													<label class=" oe_form_label oe_align_right"
														...
														<tr class="oe_form_group_row">
															...
															<td class="oe_form_group_cell" width="99%" colspan="1">
																<span
																class="oe_form_field oe_form_field_many2one oe_form_field_with_button oe_form_required">
																	<fmt:formatDate value="${leaveAppVO.leaveAppBackonDuty}" pattern="dd-MMM-yyyy" var="newdatevar" /><c:out value="${newdatevar}" /> </span>
															</td>
														</tr>
														<tr class="oe_form_group_row">
															<td class="oe_form_group_cell oe_form_group_cell_label"
														...
														<tr class="oe_form_group_row">
															...
															<td class="oe_form_group_cell" width="99%" colspan="1">
																<span
																class="oe_form_field oe_form_field_many2one oe_form_field_with_button oe_form_required">
																	 <fmt:formatDate value="${leaveAppVO.recommendedDate}" pattern="dd-MMM-yyyy" var="newdatevar" /><c:out value="${newdatevar}" /></span></span>
															</td>
														</tr>
		...
		<div class=" oe_form_sheetbg">
			...
			<div class="oe_form_sheet oe_form_sheet_width">
				...
				<table class="oe_form_group " cellspacing="0" cellpadding="0"
					...
					<tbody>
						<tr class="oe_form_group_row">
							<td class="oe_form_group_cell" width="50%" colspan="0">
								<table class="oe_form_group " cellspacing="0" cellpadding="0"
									border="0">
									<tbody>
										<tr class="oe_form_group_row">
											...
											<td class="oe_form_group_cell" width="99%" colspan="1">
												<span
												class="oe_form_field oe_form_field_many2one
												oe_form_field_with_button oe_form_required">
													${leaveAppVO.leaveAppEmp.employeeFullName} </span>
											</td>
										</tr>
										...
										<tr class="oe_form_group_row">
											...
											<td class="oe_form_group_cell" width="99%" colspan="1">
												...
												class="oe_form_field oe_form_field_many2one
													oe_form_field_with_button oe_form_required">
													<fmt:formatDate value="${leaveAppVO.leaveAppFromDate}"
									...
									<tbody>
										...
										<tr class="oe_form_group_row">
											...
											<td class="oe_form_group_cell" width="99%" colspan="1">
												...
												class="oe_form_field oe_form_field_many2one
											oe_form_field_with_button oe_form_required">
													<fmt:formatDate value="${leaveAppVO.leaveAppToDate}"
														pattern="dd-MMM-yyyy" var="newdatevar" /> <c:out
														value="${newdatevar}" />
											</span>
											</td>
									...
									<tbody>
										<tr class="oe_form_group_row">
											<td class="oe_form_group_cell oe_form_group_cell_label"
												width="1%" colspan="1"><label
												class=" oe_form_label oe_align_right"
												for="oe-field-input-17"> Available Leaves</label></td>
										...
										<tr class="oe_form_group_row">
											...
											<td class="oe_form_group_cell" width="99%" colspan="1">
												...
												class="oe_form_field oe_form_field_many2one
										oe_form_field_with_button oe_form_required">
													<fmt:formatDate value="${leaveAppVO.leaveAppBackonDuty}"
														pattern="dd-MMM-yyyy" var="newdatevar" /> <c:out
														value="${newdatevar}" />
											</span>
											</td>
									...
									<tbody>
										<tr class="oe_form_group_row">
											<td class="oe_form_group_cell oe_form_group_cell_label"
												width="1%" colspan="1"><label
												class=" oe_form_label oe_align_right"
												for="oe-field-input-17"> CL.</label></td>
											<td class="oe_form_group_cell" width="99%" colspan="1">
												<span
												class="oe_form_field oe_form_field_many2one
												oe_form_field_with_button oe_form_required">
													${leaveAppVO.leaveAppEmp.employeeCL}</span>
											</td>
										</tr>
										<tr class="oe_form_group_row">
											...
											<td class="oe_form_group_cell oe_form_group_cell_label"
												width="1%" colspan="1"><label
												class=" oe_form_label oe_align_right"
												for="oe-field-input-17"> EL.</label></td>
											<td class="oe_form_group_cell" width="99%" colspan="1">
												<span
												class="oe_form_field oe_form_field_many2one
												oe_form_field_with_button oe_form_required">
													${leaveAppVO.leaveAppEmp.employeeEL} </span>
											</td>
										</tr>
										<tr class="oe_form_group_row">
											<td class="oe_form_group_cell oe_form_group_cell_label"
											...
											<td class="oe_form_group_cell" width="99%" colspan="1">
												...
												class="oe_form_field oe_form_field_many2one
												oe_form_field_with_button oe_form_required">
													<fmt:formatDate value="${leaveAppVO.recommendedDate}"
														pattern="dd-MMM-yyyy" var="newdatevar" /> <c:out
														value="${newdatevar}" />
											</span>
											</td>
